...
def help(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                    InlineKeyboardButton('💌 ʙᴇɴɪ ɢʀᴜʙᴀ ᴇᴋʟᴇ 💌', url=f'http://t.me/Rovsen_song_bot?startgroup=new'),
                  ],[
                    InlineKeyboardButton('📚 ᴋᴀɴᴀʟ', url=f'https://t.me/virusscanner')
                  ],[
                    InlineKeyboardButton('👤 ᴏᴡɴᴇʀ', url=f'https://t.me/virusscanner')
                  ]
            ]
        )
    )
